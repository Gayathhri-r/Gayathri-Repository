...
public class ExcelUtil {
	...
	public static int getRowCount(String BaseExcelPath,String sheetname) throws Exception {
	...
	public static int getCellCount(String BaseExcelPath,String sheetname,int rownum) throws Exception {
	...
	//get cell value
	public static String getCellData(String BaseExcelPath,String sheetname, int rownum, int colnum) throws Exception{
